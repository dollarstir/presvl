        ...
        <div class="header__bottom">
          <div class="container">
            <nav class="navbar navbar-expand-xl p-0 align-items-center">
              <a class="site-logo site-title" href="home"><img src="vv/assets/images/logo.jpg" style="max-width: 80px !important;"  alt="site-logo"></a>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-12 text-center">
            <a href="vv/#0" class="footer-logo"><img src="vv/assets/images/logo.jpg" alt="image"></a>
